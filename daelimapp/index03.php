...
<html>
    ...
    <body>
                <div data-role="page" id="aaa">
                    ...
                    <div class="index03_content">
                        <div class="index03_img02"></div>
                        <div class="index03_btn">
                            <div class="index03_btn01">
                                <a href="./index04.php" data-ajax="false">
                                <div class="index03_btn_img01"></div>
                                <p>오디오 가이드</p>
                                </a>
                            </div>
                            <div class="index03_btn02">
                                <a href="./index07.php" data-ajax="false">
                                <div class="index03_btn_img02"></div>
                                <p>AR 체험</p>
                                </a>
                            </div>
                            <div class="index03_btn00">
                                <div class="index03_btn03">
                                    <a href="#">
                                    <div class="index03_btn_img03"></div>
                                    <p>스템프투어</p>
                                    </a>
                                </div>
                                <div class="index03_btn04">
                                    <a href="#">
                                    <div class="index03_btn_img04"></div>
                                    <p>작품위치</p>
                                    </a>
                                </div>
                            </div>
