...
<html>
    ...
    <body>
                <div data-role="page" id="aaa">
                    ...
                    <div class="index12_img">
                        <img src="./images/index12_img01.png" width="41.6666%"></img>
                    </div>
                    
                    <form class="index12_login" action="./outlet.php" method="GET" data-ajax="false">
                        <input type="hidden" name="proce" value="login"/>
                        <div class="index12_id">
                            <p>아이디</p>
                            <input type="text" name="id" placeholder="아이디를 입력해주세요."/>
                        </div>
                        
                        <div class="index12_pwd">
                            <p>비밀번호</p>
                            <input type="password" name="passwd" placeholder="비밀번호를 입력해주세요."/>
                        </div>
                        
                        <div class="index12_autologin_box">
                            <a href="#" class="index12_autologin">
                                <img src="./images/index12_img02.png" width="20%"></img>
                                <p>자동 로그인</p>
                            </a>
                        </div>
                        
                        <div class="index12_submit">
                            <input type="submit" data-role="none" value="로그인"/>
                        </div>
                    </form>
                    
                    <div class="index12_register_box">
                        <a class="index12_register" href="#" data-ajax="false">회원가입</a>
                    </div>
                    
                    <div class="index12_search_box">
                        <div class="index12_bar">
                            <a class="index12_search" href="#" data-ajax="false">아이디 찾기</a>
                            <div class="index12_box">
                                <div class="index12_box01"></div>
                            </div>
                            <a class="index12_search" href="#" data-ajax="false">비밀번호 찾기</a>
                        </div>
                    </div>
